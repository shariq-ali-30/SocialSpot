    ...
    >
      ...
      >
        <div className="px-[clamp(1rem,4vw,1.5rem)] py-[clamp(1.5rem,5vw,1.75rem)] text-center">
          <div className="w-[clamp(3.25rem,12vw,3.5rem)] h-[clamp(3.25rem,12vw,3.5rem)] mx-auto mb-[clamp(0.8rem,2vw,1rem)] rounded-full bg-red-50 flex items-center justify-center">
            <i className="ph-bold ph-trash text-[clamp(1.5rem,5vw,1.875rem)] text-red-500"></i>
          </div>
        ...
        <div className="px-[clamp(1rem,4vw,1.5rem)] pb-[clamp(1rem,4vw,1.5rem)] flex gap-[clamp(0.5rem,1.5vw,0.75rem)]">
          ...
          <button
            onClick={deletePost}
            type="button"
            className="flex-1 h-[clamp(2.6rem,7vw,2.75rem)] rounded-[clamp(0.5rem,1.2vw,0.625rem)] bg-red-500 text-white font-semibold hover:bg-red-600 transition text-[clamp(0.75rem,1.6vw,0.875rem)] cursor-pointer shadow-sm"
          >
            Delete
          </button>
        </div>
